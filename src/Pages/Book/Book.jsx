...
function Book() {
  ...
  return (
    <div>
      ...
      <div className="">
        <div
          className={`fixed bottom-0 left-0 w-full h-1/2 rounded-t-3xl bg-gray-50 bg-opacity-90 transpa text-black z-10 overflow-y-auto mx-auto transition-transform duration-300 ease-in-out ${
        ...
        >
          <div className="p-6">
            ...
            <div className="mt-6 bg-white p-6 rounded-lg w-full flex gap-2 flex-wrap flex-row ">
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="mx-2 text-right">₹ 696</div>
